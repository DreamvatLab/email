...
require (
	github.com/DreamvatLab/logs v1.0.2 // indirect
	github.com/DreamvatLab/oauth2go v1.0.16 // indirect
	...
	github.com/kazegusuri/grpc-panic-handler v0.0.0-20160502122501-093ec776affc // indirect
