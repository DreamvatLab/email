...
const (
	EmailService_Send_FullMethodName = "/email.EmailService/Send"
)
...
type EmailServiceClient interface {
	Send(ctx context.Context, in *EmailDTO, opts ...grpc.CallOption) (*SendResponse, error)
}
...
func (c *emailServiceClient) Send(ctx context.Context, in *EmailDTO, opts ...grpc.CallOption) (*SendResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendResponse)
	err := c.cc.Invoke(ctx, EmailService_Send_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EmailServiceServer interface {
	Send(context.Context, *EmailDTO) (*SendResponse, error)
}
...
func (UnimplementedEmailServiceServer) Send(context.Context, *EmailDTO) (*SendResponse, error) {
...
func _EmailService_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmailService_Send_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmailServiceServer).Send(ctx, req.(*EmailDTO))
	}
